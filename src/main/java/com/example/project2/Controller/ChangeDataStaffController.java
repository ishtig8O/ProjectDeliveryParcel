...
import com.example.project2.Model.ChangeDataStaffModel;
...
public class ChangeDataStaffController {
    ...
    ChangeDataStaffModel changeDataStaffModel;

    public ChangeDataStaffController() {
        this.changeDataStaffModel = new ChangeDataStaffModel();
    }
    ...
    void login(ActionEvent event) throws IOException {
        ...
        changeDataStaffModel.changeDataStaff(name, phone);
    }
}
